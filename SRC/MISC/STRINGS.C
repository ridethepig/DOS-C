...
static BYTE *stringsRcsId = "$Header:   C:/dos-c/src/misc/strings.c_v   1.3   31 Jan 1998  8:15:50   patv  $";
#endif

/* $Log:   C:/dos-c/src/misc/strings.c_v  $
 *	
 *	   Rev 1.3   31 Jan 1998  8:15:50   patv
...
COUNT fstrncmp(lpszStr1, lpszStr2, nLen)
REG BYTE FAR *lpszStr1, FAR *lpszStr2;
COUNT nLen;
{
	COUNT idx = 1;
