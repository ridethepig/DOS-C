...
/* $Logfile:   C:/usr/patv/dos-c/src/fs/fcbfns.c_v  $ */
#ifdef VERSION_STRINGS
static BYTE *RcsId = "$Header:   C:/usr/patv/dos-c/src/fs/fcbfns.c_v   1.7   06 Dec 1998  8:44:10   patv  $";
#endif

/* $Log:   C:/usr/patv/dos-c/src/fs/fcbfns.c_v  $
 * 
