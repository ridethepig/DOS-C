...
/* $Logfile:   C:/usr/patv/dos-c/src/fs/error.c_v  $ */
#ifdef VERSION_STRINGS
static BYTE *errorRcsId = "$Header:   C:/usr/patv/dos-c/src/fs/error.c_v   1.5   06 Dec 1998  8:43:54   patv  $";
#endif

/* $Log:   C:/usr/patv/dos-c/src/fs/error.c_v  $
 * 
