...
/* $Logfile:   C:/dos-c/src/fs/prf.c_v  $ */
#ifdef VERSION_STRINGS
static BYTE *prfRcsId = "$Header:   C:/dos-c/src/fs/prf.c_v   1.4   04 Jan 1998 23:14:38   patv  $";
#endif

/* $Log:   C:/dos-c/src/fs/prf.c_v  $
 * 
...
WORD 
printf (CONST BYTE *fmt, BYTE *args)
{
	charp = 0;
