...
static BYTE *dosfnsRcsId = "$Header:   C:/usr/patv/dos-c/src/fs/dosfns.c_v   1.10   06 Dec 1998  8:44:42   patv  $";
#endif

/* $Logfile:   C:/usr/patv/dos-c/src/fs/dosfns.c_v  $ */

/* $Log:   C:/usr/patv/dos-c/src/fs/dosfns.c_v  $
 * 
...
static VOID DosGetFile(BYTE FAR *lpszPath, BYTE FAR *pszDosFileName);

static VOID
DosGetFile(BYTE FAR *lpszPath, BYTE FAR *lpszDosFileName)
{
