...
/* $Logfile:   C:/dos-c/src/kernel/initoem.c_v  $ */
#ifdef VERSION_STRINGS
static BYTE *RcsId = "$Header:   C:/dos-c/src/kernel/initoem.c_v   1.4   04 Jan 1998 23:15:16   patv  $";
#endif

/* $Log:   C:/dos-c/src/kernel/initoem.c_v  $
 * 
