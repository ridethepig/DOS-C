...
/* $Logfile:   C:/usr/patv/dos-c/src/kernel/ioctl.c_v  $ */
#ifdef VERSION_STRINGS
static BYTE *RcsId = "$Header:   C:/usr/patv/dos-c/src/kernel/ioctl.c_v   1.7   06 Dec 1998  8:48:22   patv  $";
#endif

/* $Log:   C:/usr/patv/dos-c/src/kernel/ioctl.c_v  $
 * 
