...
/* $Logfile:   C:/usr/patv/dos-c/src/kernel/dsk.c_v  $ */
#ifdef VERSION_STRINGS
static BYTE *dskRcsId = "$Header:   C:/usr/patv/dos-c/src/kernel/dsk.c_v   1.7   06 Dec 1998  8:45:18   patv  $";
#endif

/* $Log:   C:/usr/patv/dos-c/src/kernel/dsk.c_v  $
 * 
...
init (rqptr rp)
{
	...
	COUNT HardDrive, nHardDisk, Unit;
